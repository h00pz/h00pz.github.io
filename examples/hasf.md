...
- [2. Governing Philosophy](#2-governing-philosophy)
  - [2.1 Operator-first](#21-operator-first)
  - [2.2 Semantics before machinery](#22-semantics-before-machinery)
  - [2.3 One canonical truth per concern](#23-one-canonical-truth-per-concern)
  - [2.4 Preserve source, regenerate interpretation](#24-preserve-source-regenerate-interpretation)
  - [2.5 Honest incompleteness beats fabricated completeness](#25-honest-incompleteness-beats-fabricated-completeness)
  - [2.6 KISS is a governing constraint](#26-kiss-is-a-governing-constraint)
  - [2.7 How to work versus what is true](#27-how-to-work-versus-what-is-true)
- [3. Applicability](#3-applicability)
- [4. Required Architecture Layers](#4-required-architecture-layers)
  - [4.1 Intent layer](#41-intent-layer)
  - [4.2 AI application subsystem layer](#42-ai-application-subsystem-layer)
  - [4.3 Canonical semantics layer](#43-canonical-semantics-layer)
  - [4.4 Workflow layer](#44-workflow-layer)
  - [4.5 Information layer](#45-information-layer)
  - [4.6 Operator experience layer](#46-operator-experience-layer)
  - [4.7 Intelligence layer](#47-intelligence-layer)
  - [4.8 Harness and evaluation layer](#48-harness-and-evaluation-layer)
  - [4.9 Agent runtime and sandbox layer](#49-agent-runtime-and-sandbox-layer)
  - [4.10 Platform layer](#410-platform-layer)
  - [4.11 Governance layer](#411-governance-layer)
- [5. The Required Specification Structure](#5-the-required-specification-structure)
  - [A. Executive Summary](#a-executive-summary)
  - [B. Operator Outcome and Governing Question](#b-operator-outcome-and-governing-question)
  - [C. Category Errors and Misinterpretations to Prevent](#c-category-errors-and-misinterpretations-to-prevent)
  - [D. Definition of Complete](#d-definition-of-complete)
  - [E. Conceptual Model](#e-conceptual-model)
  - [F. Canonical Ownership and Authority Ladder](#f-canonical-ownership-and-authority-ladder)
  - [G. Current Truth and History](#g-current-truth-and-history)
  - [H. State Machines](#h-state-machines)
  - [I. Canonical Record Model](#i-canonical-record-model)
  - [J. Projection and Consistency Model](#j-projection-and-consistency-model)
  - [K. Operator Correction Model](#k-operator-correction-model)
  - [L. Identity Resolution](#l-identity-resolution)
  - [M. Task and Commitment Semantics](#m-task-and-commitment-semantics)
  - [N. Workflow Continuation and Exhaustion](#n-workflow-continuation-and-exhaustion)
  - [O. Model, Prompt, and AI Contract](#o-model-prompt-and-ai-contract)
  - [P. Retrieval and Freshness Contract](#p-retrieval-and-freshness-contract)
  - [Q. External Provider and Data Egress Contract](#q-external-provider-and-data-egress-contract)
  - [R. Operator Information Architecture](#r-operator-information-architecture)
  - [S. Operator Surface Definition](#s-operator-surface-definition)
  - [T. Interaction and Editing Contract](#t-interaction-and-editing-contract)
  - [U. Security and Privacy](#u-security-and-privacy)
  - [V. Runtime and Deployment Views](#v-runtime-and-deployment-views)
  - [W. Architecture Decision Records](#w-architecture-decision-records)
  - [X. C4 and Diagram Requirements](#x-c4-and-diagram-requirements)
  - [Y. Evidence and Provenance](#y-evidence-and-provenance)
  - [Z. Idempotency, Retry, and Stale Work](#z-idempotency-retry-and-stale-work)
  - [AA. Replay and Observability](#aa-replay-and-observability)
  - [AB. Forbidden Outcomes](#ab-forbidden-outcomes)
  - [AC. Acceptance Plan](#ac-acceptance-plan)
  - [AD. Capability and Data Preflight](#ad-capability-and-data-preflight)
  - [AE. Non-Goals](#ae-non-goals)
  - [AF. Stop Rule](#af-stop-rule)
  - [AG. Feature Recall and Architecture Weaving](#ag-feature-recall-and-architecture-weaving)
  - [AH. Architecture Evolution, Versioning, and Forking](#ah-architecture-evolution-versioning-and-forking)
  - [AI. Specification and Pull Request Naming Contract](#ai-specification-and-pull-request-naming-contract)
  - [AJ. Architecture Smells Seed](#aj-architecture-smells-seed)
  - [AK. Runtime Configuration and Kubernetes Deployment Contract](#ak-runtime-configuration-and-kubernetes-deployment-contract)
  - [AL. Build and Delivery Acceleration Contract](#al-build-and-delivery-acceleration-contract)
  - [AM. Chain Delivery Visibility and End-to-End Progress Contract](#am-chain-delivery-visibility-and-end-to-end-progress-contract)
  - [AN. Git-Tracked Slice, TDD, and Pull Request Delivery Record Contract](#an-git-tracked-slice-tdd-and-pull-request-delivery-record-contract)
  - [AO. Delivery Scope Hierarchy and End-State Delivery Snapshot Contract](#ao-delivery-scope-hierarchy-and-end-state-delivery-snapshot-contract)
  - [AP. Harness Architecture and Documentation Contract](#ap-harness-architecture-and-documentation-contract)
  - [AQ. Prompt Engineering and Architecture Contract](#aq-prompt-engineering-and-architecture-contract)
  - [AR. MCP Capability Access Plane and Connector Architecture Contract](#ar-mcp-capability-access-plane-and-connector-architecture-contract)
  - [AS. Agent Runtime, Sandbox, and Execution Architecture Contract](#as-agent-runtime-sandbox-and-execution-architecture-contract)
  - [AT. AI Application Subsystem Architecture Contract](#at-ai-application-subsystem-architecture-contract)
  - [AU. Agent Operating Instructions and Repository Truth Contract](#au-agent-operating-instructions-and-repository-truth-contract)
- [6. Architecture Document Set for a New Project](#6-architecture-document-set-for-a-new-project)
  - [00 — Project Primer](#00--project-primer)
  - [01 — Architecture Constitution](#01--architecture-constitution)
  - [02 — System Architecture](#02--system-architecture)
  - [03 — Operator Experience and Style Guide](#03--operator-experience-and-style-guide)
  - [04 — Feature Memory Ledger](#04--feature-memory-ledger)
  - [05 — Architecture Smells Seed](#05--architecture-smells-seed)
  - [06 — Chain Delivery Register](#06--chain-delivery-register)
  - [07 — Delivery Record Index](#07--delivery-record-index)
  - [08 — Epic and Feature Register](#08--epic-and-feature-register)
  - [09 — Harness Architecture and Evaluation Plan](#09--harness-architecture-and-evaluation-plan)
  - [10 — Prompt Architecture and Catalog](#10--prompt-architecture-and-catalog)
  - [11 — MCP Capability Access and Connector Architecture](#11--mcp-capability-access-and-connector-architecture)
  - [12 — Agent Runtime and Sandbox Architecture](#12--agent-runtime-and-sandbox-architecture)
  - [13 — AI Application Subsystem Architecture](#13--ai-application-subsystem-architecture)
  - [14 — Current As-Built Architecture](#14--current-as-built-architecture)
  - [Repository-level Agent Operating Contract](#repository-level-agent-operating-contract)
- [7. Feature Specification Template](#7-feature-specification-template)
- [8. Pre-Build Response Required From the Implementer](#8-pre-build-response-required-from-the-implementer)
- [9. Narrow Build Order](#9-narrow-build-order)
- [10. Documentation Taxonomy](#10-documentation-taxonomy)
  - [Agent operating instructions](#agent-operating-instructions)
  - [Architecture specifications](#architecture-specifications)
  - [Current As-Built Architecture](#current-as-built-architecture)
  - [ADRs](#adrs)
  - [Diátaxis user documentation](#diátaxis-user-documentation)
  - [Delivery reports](#delivery-reports)
  - [Harness documentation and run evidence](#harness-documentation-and-run-evidence)
  - [Prompt architecture and change records](#prompt-architecture-and-change-records)
  - [MCP capability access and connector architecture records](#mcp-capability-access-and-connector-architecture-records)
  - [Agent runtime and sandbox architecture records](#agent-runtime-and-sandbox-architecture-records)
  - [AI application subsystem architecture records](#ai-application-subsystem-architecture-records)
  - [Runbooks](#runbooks)
- [11. Repository Layout](#11-repository-layout)
- [12. Document and Architecture Versioning](#12-document-and-architecture-versioning)
- [13. Review Roles](#13-review-roles)
- [14. Quality Bar](#14-quality-bar)
- [15. Final Governing Rules](#15-final-governing-rules)
- [16. The h00pz Test](#16-the-h00pz-test)
- [17. Closing Principle](#17-closing-principle)
