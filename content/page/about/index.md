...
This blog is really about two systems I build. **PortfolioOS**, or pOS, is a self-hosted financial system: it reads the world, holds what I believe about it, and helps me run my own money without a bank deciding how. **Atlas** is the same set of ideas pointed at personal knowledge instead of markets. Both run on small models I host myself, and I do that on purpose, for sovereignty, because I'd rather own the whole stack than rent it from a vendor whose pricing, terms, and availability I don't control.

Neither system is open source, and there's no public repository for the code. What I share here is the architecture and the reasoning behind it, along with real artifacts pulled straight out of the systems, a spec, a plan, a config, a full weekend brief, a chunk of the actual code, reproduced in a post when it makes a point better than prose would. The source stays private; the thinking, and the pieces that carry it, don't.
