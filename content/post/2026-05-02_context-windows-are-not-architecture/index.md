...
There's the well-known problem of attention spread thin, where the one decisive sentence competes with thousands of irrelevant ones and sometimes loses, the effect <a href="https://arxiv.org/abs/2307.03172" target="_blank" rel="noopener">Lost in the Middle</a> measured directly: give a model a long context and it reliably struggles most with the information parked in the middle of it. There's staleness, where old context outranks new because there's simply more of it. There's leakage, where information that should have stayed on the far side of a seam ends up shaping a decision it was never supposed to touch. And there's the quiet erosion of reproducibility, because the input is no longer a defined contract but a snapshot of an accumulating pile.
