...
There's a genuinely opposite view, held by people far smarter than me, and it's worth naming because this whole post argues against it. Andrej Karpathy's <a href="https://x.com/karpathy/status/1707437820045062561" target="_blank" rel="noopener">picture of the LLM as an operating system</a> puts the model at the center as the kernel, with context, tools, and memory arranged around it as peripherals. That's coherent, and from where he sits it may even be right. I've just come to the reverse conclusion from building things that had to survive their own models: the model is the peripheral, and the architecture is the kernel. Worth noting that Karpathy himself has since <a href="https://www.dwarkesh.com/p/andrej-karpathy" target="_blank" rel="noopener">cooled on the near term</a>, calling this a decade of agents rather than a year and naming memory and planning as the pieces that aren't there yet, which are exactly the pieces I keep outside the model on purpose.
